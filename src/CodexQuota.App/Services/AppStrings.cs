...
internal static partial class AppStrings
{
    ...
    private static readonly IReadOnlyDictionary<string, string> Fallback =
        new Dictionary<string, string>(StringComparer.Ordinal)
        {
            ...
            ["Ui.ImminentHours"] = "Absolute date within",
            ["Ui.ImminentHoursTooltip"] = "Show the local date instead of a countdown when a reset is closer than this many hours (0 = always count down)",
